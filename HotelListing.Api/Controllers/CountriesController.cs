...
public class CountriesController(ICountriesService countriesService) : BaseApiController
{
    ...
    public async Task<ActionResult<PageResult<GetCountriesDto>>> GetCountries([FromQuery] PaginationParameters paginationParameters, [FromQuery] CountryFilterParameters filters)
    {
    ...
    public async Task<ActionResult<GetCountryHotelsDto>> GetCountryHotels(
        ...
        [FromQuery] PaginationParameters paginationParameters, [FromQuery] CountryFilterParameters filters)
    {
    ...
    public async Task<ActionResult<GetCountryDto>> PostCountry(CreateCountryDto createDto)
    {
        ...
        return CreatedAtAction(
            nameof(GetCountry),new { id = result.Value!.Id },result.Value
        );
    }
